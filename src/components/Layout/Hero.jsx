    ...
    <section className="mt-16 w-full bg-silver h-auto pb-10 lg:pt-6">
      <div className="lg:flex lg:justify-between px-10">
        <div className="lg:px-16 pt-20 lg:pr-0 lg:w-1/2">
          ...
          It's not about the money, though that's nice to have. At the end of the day, it's really about matching the right buyer to the right seller. 
          We're matchmakers—real estate macho'S.
          </p>
